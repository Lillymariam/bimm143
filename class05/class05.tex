...
\hypersetup{unicode=true,
            pdftitle={Lecture 5 work},
            pdfauthor={Nada Boutros},
            pdfborder={0 0 0},
            breaklinks=true}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{barplot}\NormalTok{(mouse}\OperatorTok{$}\NormalTok{Count,}\DataTypeTok{horiz =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{names.arg =}\NormalTok{ mouse}\OperatorTok{$}\NormalTok{Feature, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{,}\DataTypeTok{col =} \KeywordTok{cm.colors}\NormalTok{(}\DecValTok{11}\NormalTok{),}\DataTypeTok{ylab=}\StringTok{""}\NormalTok{,}\DataTypeTok{main =} \StringTok{"Number of Features in the Mouse GRCm38 Genome"}\NormalTok{,}\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{8000}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{barplot}\NormalTok{(mouse}\OperatorTok{$}\NormalTok{Count,}\DataTypeTok{horiz =} \OtherTok{TRUE}\NormalTok{, }\DataTypeTok{names.arg =}\NormalTok{ mouse}\OperatorTok{$}\NormalTok{Feature, }\DataTypeTok{las=}\DecValTok{1}\NormalTok{,}\DataTypeTok{col =} \KeywordTok{cm.colors}\NormalTok{(}\DecValTok{11}\NormalTok{),}\DataTypeTok{main =} \StringTok{"Number of Features in the Mouse GRCm38 Genome"}\NormalTok{,}\DataTypeTok{xlim =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{80000}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Section 3:using color in plots}
...
\KeywordTok{barplot}\NormalTok{(mf}\OperatorTok{$}\NormalTok{Count, }\DataTypeTok{names.arg =}\NormalTok{ mf}\OperatorTok{$}\NormalTok{Sample, }\DataTypeTok{col =} \KeywordTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{,}\StringTok{"pink"}\NormalTok{), }\DataTypeTok{las=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{palette}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\StringTok{"purple"}\NormalTok{,}\StringTok{"turquoise2"}\NormalTok{,}\StringTok{"blue"}\NormalTok{))}
\KeywordTok{plot}\NormalTok{(e}\OperatorTok{$}\NormalTok{Condition1,e}\OperatorTok{$}\NormalTok{Condition2, }\DataTypeTok{col=}\NormalTok{ e}\OperatorTok{$}\NormalTok{State)}
\end{Highlighting}
\end{Shaded}

\includegraphics{class05_files/figure-latex/unnamed-chunk-1-15.pdf}
